...
- [JHipster JDL - JHipster Domain Language](https://www.jhipster.tech/jdl/intro)
  - [JHipster JDL - JHipster Domain Language](https://easynode.github.io/jdl/)
- [dvdrental sql-to-jdl](https://github.com/giocosmiano/exploring-sql-to-jdl-using-postgres)
    - run the application to generate `dvdrental-jdl.jh`
    - run `jhipster jdl ./dvdrental-jdl.jh`
        - NOTE: make sure to use "N", not to override initially created JHipster codes
```bash
  jhipster jdl ./dvdrental-jdl.jh
```
...
To build the final jar and optimize the dvdrental application for production, run:
