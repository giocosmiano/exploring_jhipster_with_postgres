...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILMACTOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILMACTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILMACTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILMACTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILMACTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILMACTOR actions', async () => {
      const expectedActions = [
        {
