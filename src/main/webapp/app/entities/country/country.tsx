  ...
  return (
    <div>
      <h2 id="country-heading" data-cy="CountryHeading">
        <Translate contentKey="dvdrentalApp.country.home.title">Countries</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="dvdrentalApp.country.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="dvdrentalApp.country.home.createLabel">Create new Country</Translate>
          </Link>
        </div>
      </h2>
          ...
          {countryList && countryList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="dvdrentalApp.country.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('countryId')}>
                    <Translate contentKey="dvdrentalApp.country.countryId">Country Id</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('country')}>
                    <Translate contentKey="dvdrentalApp.country.country">Country</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('lastUpdate')}>
                    <Translate contentKey="dvdrentalApp.country.lastUpdate">Last Update</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {countryList.map((country, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>{country.lastUpdate ? <TextFormat type="date" value={country.lastUpdate} format={APP_DATE_FORMAT} /> : null}</td>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="dvdrentalApp.country.home.notFound">No Countries found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
