...
export const CountryUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...countryEntity,
          lastUpdate: convertDateTimeFromServer(countryEntity.lastUpdate),
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="dvdrentalApp.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
            <Translate contentKey="dvdrentalApp.country.home.createOrEditLabel">Create or edit a Country</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('dvdrentalApp.country.countryId')}
              ...
              />
              <ValidatedField
                label={translate('dvdrentalApp.country.country')}
                id="country-country"
                name="country"
                data-cy="country"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('dvdrentalApp.country.lastUpdate')}
                id="country-lastUpdate"
                name="lastUpdate"
                data-cy="lastUpdate"
                type="datetime-local"
