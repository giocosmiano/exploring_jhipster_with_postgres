    ...
    <Row>
      <Col md="8">
        <h2 data-cy="countryDetailsHeading">
          <Translate contentKey="dvdrentalApp.country.detail.title">Country</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="countryId">
              <Translate contentKey="dvdrentalApp.country.countryId">Country Id</Translate>
            </span>
          </dt>
          <dd>{countryEntity.countryId}</dd>
          <dt>
            <span id="country">
              <Translate contentKey="dvdrentalApp.country.country">Country</Translate>
            </span>
          </dt>
          <dd>{countryEntity.country}</dd>
          <dt>
            <span id="lastUpdate">
              <Translate contentKey="dvdrentalApp.country.lastUpdate">Last Update</Translate>
            </span>
          </dt>
          <dd>{countryEntity.lastUpdate ? <TextFormat value={countryEntity.lastUpdate} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
        </dl>
