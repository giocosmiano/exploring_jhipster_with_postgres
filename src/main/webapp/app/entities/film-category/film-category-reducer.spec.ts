...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILMCATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILMCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILMCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILMCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILMCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILMCATEGORY actions', async () => {
      const expectedActions = [
        {
