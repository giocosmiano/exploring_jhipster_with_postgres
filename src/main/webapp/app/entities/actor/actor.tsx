  ...
  return (
    <div>
      <h2 id="actor-heading" data-cy="ActorHeading">
        <Translate contentKey="dvdrentalApp.actor.home.title">Actors</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="dvdrentalApp.actor.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="dvdrentalApp.actor.home.createLabel">Create new Actor</Translate>
          </Link>
        </div>
      </h2>
          ...
          {actorList && actorList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="dvdrentalApp.actor.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('actorId')}>
                    <Translate contentKey="dvdrentalApp.actor.actorId">Actor Id</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('firstName')}>
                    <Translate contentKey="dvdrentalApp.actor.firstName">First Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('lastName')}>
                    <Translate contentKey="dvdrentalApp.actor.lastName">Last Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('lastUpdate')}>
                    <Translate contentKey="dvdrentalApp.actor.lastUpdate">Last Update</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {actorList.map((actor, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>{actor.lastUpdate ? <TextFormat type="date" value={actor.lastUpdate} format={APP_DATE_FORMAT} /> : null}</td>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="dvdrentalApp.actor.home.notFound">No Actors found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
