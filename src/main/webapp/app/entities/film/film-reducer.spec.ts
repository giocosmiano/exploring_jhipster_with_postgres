...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './film.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches CREATE_FILM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILM actions', async () => {
      const expectedActions = [
        {
